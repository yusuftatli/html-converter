...
func main() {
    db, err := sql.Open("goracle", `"user="html/12345@localhost:1521/oracle"`)
    if err != nil {
    ...
    dbQuery :="insert into MASTERPRODUCT (PROCESSID,MALZEMECODE) values ('golang','2323'); commit;"
...
//     log.Println("database yazdırılıyor")
//     // db := ConnectDB()
//     // _ = db.AutoMigrate( & masterproduct {})
//     // _ = db.AutoMigrate( & detailproduct {})

//     // db, err := sql.Open("godror", `user="html" password="12345" connectString="localhost:1521/oracle"`)
//     // if err != nil {
//     //     log.Fatal(err)
//     // }
...
//             // insertType = GetInsertType(masterRow)
//             // writeValue(insertType)
//             // detaildata := converToDetailDto_dept_1(masterRow, uniqueID, masterId, 1, header_1, insertType, masterCode)
//             // err := db.Create( & detaildata).Error
//             //     //    dept_1 = detaildata.Id
//             // if err != nil {
//             //     log.Fatalf("Unable to execute the query. %v", err)
//             // }
//         } else if (masterRow.col18 == "2") {
//             // insertType = GetInsertType(masterRow)
//             // detaildata := converToDetailDto_dept_1(masterRow, uniqueID, masterId, 2, header_2, insertType, masterCode)
//             // err := db.Create( & detaildata).Error
//             //     //    dept_1 = detaildata.Id
//             // if err != nil {
//             //     log.Fatalf("Unable to execute the query. %v", err)
...
//             // insertType = GetInsertType(masterRow)
//             // detaildata := converToDetailDto_dept_1(masterRow, uniqueID, masterId, 3, header_3, insertType, masterCode)
//             // err := db.Create( & detaildata).Error
//             //     //    dept_1 = detaildata.Id
//             // if err != nil {
//             //     log.Fatalf("Unable to execute the query. %v", err)
...
//             // insertType = GetInsertType(masterRow)
//             // detaildata := converToDetailDto_dept_1(masterRow, uniqueID, masterId, 4, header_4, insertType, masterCode)
//             // err := db.Create( & detaildata).Error
//             //     //    dept_1 = detaildata.Id
//             // if err != nil {
//             //     log.Fatalf("Unable to execute the query. %v", err)
...
//             // insertType = GetInsertType(masterRow)
//             // detaildata := converToDetailDto_dept_1(masterRow, uniqueID, masterId, 5, header_5, insertType, masterCode)
//             // err := db.Create( & detaildata).Error
//             //     //    dept_1 = detaildata.Id
//             // if err != nil {
//             //     log.Fatalf("Unable to execute the query. %v", err)
...
// func converToDetailDto_dept_1(orders OrderDto, uniqueID string, masterid uint64, detayid uint64, header OrderDto, insertType string, masterCode string) * detailproduct {
